...
'faceting':organizing different panels, and designing the layout. In ggfun package, layer_PersHomo is using this function.
...
The development page of 'ggfun' on github https://github.com/yaweige/ggfun

The extension package of 'ggplot2': http://www.ggplot2-exts.org/gallery/
