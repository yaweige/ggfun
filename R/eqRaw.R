...
#' \describe{
#' \item{YEAR}{when the earthquark occur in year}
#' \item{MONTH}{when the earthquark occur in month}
#' \item{DAY}{when the earthquark occur in day}
#' \item{EQ_MAG_MS}{the surface-wave magnitude of the earthquake}
#' \item{COUNTRY}{the country where the earthquark occurred}
